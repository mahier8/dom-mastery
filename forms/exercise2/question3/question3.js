...
for (i = 0; i < tableData.length; i++) { // I loop through the length of the table data array
    tableData[i].addEventListener('click', function(e) { // on each item in the table data array I add a click
        ...
        newInput.addEventListener('blur', function(e) { // I add a blur event listener to the inputs I created 
